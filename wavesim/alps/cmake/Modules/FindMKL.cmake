...
#  MKL_INCLUDE_DIRS - path to include dir.
...
find_path(INTEL_MKL_DIR include/mkl.h
  PATHS $ENV{MKLROOT} ${DEFAULT_INTEL_MKL_DIR} ${INTEL_COMPILER_DIR}
  DOC "Root directory of the Intel MKL (standalone)")
...
# Include files
IF (MKL_LIBRARIES)
  message(STATUS "searching for header file")
...
IF (MKL_LIBRARIES AND MKL_INCLUDE_DIRS)
  SET(MKL_FOUND TRUE)
ELSE (MKL_LIBRARIES AND MKL_INCLUDE_DIRS)
  if (MKL_LIBRARIES AND NOT MKL_INCLUDE_DIRS)
...
ENDIF (MKL_LIBRARIES AND MKL_INCLUDE_DIRS)
