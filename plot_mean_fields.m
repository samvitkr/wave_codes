...
% xc = squeeze(X(1:end,1,:));
% zc = squeeze(Z(1:end,1,:));
% cl=5e+3;
% figure
% subplot(1,4,1)
...
nexttile
pcolor(Xph,Zph,convposph)
shading flat
axis equal

nexttile
pcolor(Xph,Zph,convnegph)
shading flat
axis equal

nexttile
pcolor(Xph,Zph,convph)
shading flat
axis equal

nexttile
pcolor(Xph,Zph,strposph)
shading flat
axis equal

nexttile
pcolor(Xph,Zph,strnegph)
shading flat
axis equal

nexttile
pcolor(Xph,Zph,strph)
shading flat
axis equal