...
{
	if (file_output)
		fprintf(output, "8 - rocFFT FFT + iFFT C2C big prime benchmark in double precision (similar to VkFFT Bluestein)\n");
	printf("8 - rocFFT FFT + iFFT C2C big prime benchmark in double precision (similar to VkFFT Bluestein)\n");
